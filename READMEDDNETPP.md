...
- minigames
  + [block tournaments](./docs/block_tournaments_ddpp.md)
  + bomb
  + fng
  + blockwave
  + survival
- quests
- [shop](./docs/shop_ddpp.md)
- police
- jail
- drop weapons and flags
- and much more

DDNet++ also has a lot of configs and commands. Make sure to check out [settings_and_commands.md](./docs/settings_and_commands_ddpp.md) for more details.
